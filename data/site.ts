...
export const site = {
  ...
  description: "Boosta Förlag ger ut personliga och praktiska faktaböcker som hjälper människor att förstå mer, fatta bättre beslut och skapa förändring.",
  ...
  nav: [
    ...
    { href: "/malla-taipale/", label: "Malla Taipale" },
